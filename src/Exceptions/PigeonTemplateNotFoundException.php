...
class PigeonTemplateNotFoundException extends PigeonException {
     ...
     */
    public function __construct($templateType, $base) {
        ...
        $message = "Can not find template [{$templateType}] or default value for [{$baseClass}: {$baseKey}]";
